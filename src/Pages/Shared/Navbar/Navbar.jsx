...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      ...
      <NavLink to="/allTouristsSpot" className="p-1 px-2">
        All Tourists Spot
      </NavLink>
      <NavLink to="/addTouristsSpot" className="p-1 px-2">
        Add Tourists Spot
      </NavLink>
      <NavLink to="/my-list" className="p-1 px-2">
        My List
      </NavLink>
    </>
  );
    ...
    <div className="navbar bg-base-200 shadow-xl px-4 max-w-screen-xl mx-auto">
      <div className="navbar-start">
        ...
        <div className="dropdown">
          ...
          <ul className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 shadow font-semibold">
            {navLinks}
          </ul>
        </div>
        {/* Logo */}
